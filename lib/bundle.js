...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    key: "dfs",
	    value: function dfs(root, target, seen, count) {
	      ...
	      var upCount = count + 1;
	      var downCount = count + 1;
	      if (this.filledPositions.has(left.toString()) && !seen.has(left.toString())) {
	        var returnLeft = this.dfs(left, target, Object.assign(seen.add(root.toString())), leftCount);
	        if (returnLeft) {
	      ...
	      if (this.filledPositions.has(right.toString()) && !seen.has(right.toString())) {
	        var returnRight = this.dfs(right, target, Object.assign(seen.add(root.toString())), rightCount);
	        if (returnRight) {
	      ...
	      if (this.filledPositions.has(down.toString()) && !seen.has(down.toString())) {
	        var returnDown = this.dfs(down, target, Object.assign(seen.add(root.toString())), downCount);
	        if (returnDown) {
	      ...
	      if (this.filledPositions.has(up.toString()) && !seen.has(up.toString())) {
	        var returnUp = this.dfs(up, target, Object.assign(seen.add(root.toString())), upCount);
	        if (returnUp) {
	    ...
	    value: function drawSeen(ctx) {
	      ...
	      if (seen.length > 1) {
	        ...
	        if (this.filledPositions.has(seen[seen.length - 1].toString())) {
	          ...
	          var fillArray = this.dfs(end, start, new Set(), 0);
	          var shortArray = fillArray[0];
	          for (var _i3 = 1; _i3 < fillArray.length; _i3++) {
	            if (fillArray[_i3].length < shortArray.length) {
	              shortArray = fillArray[_i3];
	            }
	          }
	          shapeArray = shapeArray.concat(shortArray);
	
	          var fillPointArray = this.fillPoints(shapeArray);
	          for (var _i4 = 0; _i4 < shapeArray.length; _i4++) {
	            this.filledPositions.add([shapeArray[_i4][0], shapeArray[_i4][1]]);
	          }
	          shapeArray.forEach(function (arr) {
	            _this.filledPositions.add(arr.toString());
	          });
	          fillPointArray.forEach(function (arr) {
	            _this.filledPositions.add(arr.toString());
	          });
	    ...
	    key: "fillPoints",
	    value: function fillPoints(shapeArray) {
	      var x_min = Game.DIM_X;
	      var x_max = 0;
	      var y_min = Game.DIM_Y;
	      var y_max = 0;
