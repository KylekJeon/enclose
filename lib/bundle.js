...
/***/ function(module, exports, __webpack_require__) {
	...
	document.addEventListener("DOMContentLoaded", function () {
	  ...
	  var upInterval = void 0;
	  var downInterval = void 0;
	  ...
	  $(".instruction-section").click(function () {
	    $(".instruction-section").removeClass("show");
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Game = function () {
	  ...
	  _createClass(Game, [{
	    ...
	    key: "nextLevelPage",
	    value: function nextLevelPage() {
	      var thisLevel = document.getElementById("this-level-text");
	      var nextLevel = document.getElementById("next-level-text");
	      this.clear(thisLevel);
	      this.clear(nextLevel);
	      var thisLevelText = this.findLevel(this.level);
	      thisLevel.appendChild(document.createTextNode(thisLevelText));
	      this.level += 2;
	      this.updateLevel(this.findLevel(this.level));
	      var nextLevelText = this.findLevel(this.level);
	    ...
	    key: "findLevel",
	    value: function findLevel(level) {
	    ...
	    value: function updateLives() {
	      ...
	      var textNode = document.createTextNode(this.lives);
	      this.clear(parent);
	      parent.appendChild(textNode);
	    }
	  }, {
	    ...
	    value: function randomPosition() {
	      return [(Game.DIM_X - 200) * Math.random() + 100, (Game.DIM_Y - 100) * Math.random() + 50];
	    }
	  }, {
	    key: "remove",
